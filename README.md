...
| 영역 | 역할 | 상태 |
|---|---|---|
| Operations Core | 작물과 무관한 농작업 실행관리 기반 | v0.1 구현됨, v0.2 FarmArea 구현됨; Observation·Measurement는 다음 Slice |
...
- Farm 아래의 실제 관리 공간(FarmArea) 구현, FarmTask 없이 기록할 수 있는 Observation과 수치 Measurement는 다음 Slice
