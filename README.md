...
| Baseline Modules | 실제 Weather, Disease/Pest, Crop Information, Market Information | 기상청 Weather, 전국 단위 병해충 발생정보, Crop Pack 기반 농사로 작물별 참고자료 구현됨; KAMIS 전체지역 도매 참고가격은 adapter·UI·cache 구현 완료, 배포용 자격증명 등록 대기 |
...
- 전국 단위 농사로 병해충 발생정보와 Crop Pack 기반 작물별 참고자료 카드, KAMIS 전체지역 도매 참고가격 카드(배포용 자격증명 등록 후 실제 데이터 확인)
