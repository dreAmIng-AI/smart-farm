...
| Baseline Modules | 실제 Weather, Disease/Pest, Crop Information, Market Information | 기상청 Weather와 전국 단위 농사로 병해충 발생정보 구현됨; 작물별 재배·시장 정보는 순차 도입 |
...
- 전국 단위 농사로 병해충 발생정보 카드와, 이후 공식 Crop Information·Market Information 카드
